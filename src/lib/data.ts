...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://picsum.photos/seed/irtra-estrugensen/600/400',
  ...
  },
  {
    ...
    loMejor: 'Nueva atracción, museo, restaurante',
    description: 'Espacio inspirado en el Castillo de San Felipe. Incluye un juego tipo barco donde puedes lanzar agua a otros usuarios.',
  ...
  },
  {
    ...
    description: 'Juegos mecánicos con temática de aviones, aptos para niños y adultos que deseen un vuelo suave.',
    imageUrl: 'https://picsum.photos/seed/irtra-kids/600/400',
    location: 'Área nueva',
    hours: 'Jueves 10:00-17:00 | Viernes a domingo 10:00-18:00',
    telefono: '7722-9450',
    rating: 4.5,
    reviewCount: 120,
    intensity: 'Baja',
    targetAudience: 'Infantil / Familiar',
    capacityPerTurn: 24,
    durationMinutes: 5,
    peopleInQueue: 15
  },
  {
    ...
    description: 'Complejo de toboganes abiertos y cerrados con diferentes velocidades y recorridos.',
    imageUrl: 'https://picsum.photos/seed/irtra-serpientes/600/400',
    location: 'Xocomil Central',
    hours: 'Jueves a domingo 09:00-17:00',
    telefono: '7722-9400',
    rating: 4.7,
    reviewCount: 250,
  ...
  // RESTAURANTES
  {
    ...
    description: 'Espacio con ambiente relajante, opciones de comida internacional y acceso a servicios de descanso.',
    imageUrl: images.find(i => i.id === 'restaurant-corozos')?.imageUrl || '',
    location: 'Zona de servicios, Hostales',
  ...
  // BAÑOS
  {
    ...
    parque: 'Xetulul',
    zona: 'Plaza Italia',
    description: 'Baños públicos con altos estándares de limpieza y mantenimiento constante.',
