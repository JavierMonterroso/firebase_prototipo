  ...
  return (
    <MobileContainer noPadding className="bg-white">
      <div className="px-6 pt-12 pb-8">
        <Link href="/login" className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-irtra-bg text-slate-800 mb-8 active:scale-90 transition-transform">
          <ArrowLeft size={20} />
        </Link>

        <div className="mb-10">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Crear cuenta</h1>
          <p className="text-slate-500 font-medium">Únete a la comunidad de exploradores IRTRA</p>
        </div>

        <form onSubmit={handleRegister} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-slate-700 font-semibold ml-1">Nombre completo</Label>
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-500 font-medium">
            ...
            <Link href="/login" className="text-irtra-blue font-bold">
              Inicia sesión
            </Link>
          </p>
        </div>
