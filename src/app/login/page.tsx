...
export default function LoginPage() {
  ...
  return (
    <MobileContainer noPadding className="bg-background">
      {/* Visual Top Section */}
      <div className="relative h-[40vh] w-full overflow-hidden flex flex-col justify-end px-6 pb-12 hero-gradient">
        <div className="absolute top-8 left-5">
          <Link href="/" className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 backdrop-blur-md text-foreground active:scale-90 transition-transform">
            <ArrowLeft size={20} />
          </Link>
        </div>
        ...
        <div className="relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="text-4xl font-bold text-foreground leading-tight">Bienvenido a la aventura</h1>
          <p className="text-muted-foreground font-medium mt-2">Accede para comenzar tu exploración</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-end pt-1">
              <button type="button" className="text-primary text-[13px] font-bold hover:underline">¿Olvidaste tu contraseña?</button>
            </div>
          </div>
          ...
          >
            {loading ? "Preparando aventura..." : "Ingresar"}
          </Button>
        </form>
